...
import edu.ucne.registroestudiantes.domain.asignatura.usecase.GetAsignaturaUseCase
import edu.ucne.registroestudiantes.domain.asignatura.usecase.UpsertAsignaturaUseCase
...
class EditAsignaturaViewModel @Inject constructor(
    ...
    private suspend fun isValid(): Boolean {
        ...
        if (valid) {
            val existe = getAsignaturaUseCase(nombreLimpio)
